...
import com.garethahealy.githuborgmanagement.processors.users.pullrequests.MembersChangeInAnsibleVarsYamlProcessor;
import com.garethahealy.githuborgmanagement.processors.users.pullrequests.MembersChangeInConfigYamlProcessor;
import com.garethahealy.githuborgmanagement.processors.users.pullrequests.Processor;
            ...
            if (activeProcessors.contains(processor.id())) {
                for (GHPullRequest current : pullRequests) {
                    if (processor.isActive(current)) {
                        ...
                        processor.process(current, data, ldapMembers, supplementaryMembers, isDryRun);
                    } else {
