...
= github-org-management-users-help(1)
...
github-org-management-users-help - Display help information about the specified command.
...
*github-org-management users help* [*-h*] [_COMMAND_]
